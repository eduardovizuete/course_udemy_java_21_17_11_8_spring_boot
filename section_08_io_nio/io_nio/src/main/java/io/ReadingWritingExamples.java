...
//        copyBinaryFile(true);
    ...
    public static void copyTextFile(boolean buffering) {
        File src = new File("./src/main/resources/io/ReadingWritingExamples.java");
        File dest = new File("./src/main/resources/io/ReadingWritingExamples2.java");
    ...
    public static void copyBinaryFile(boolean buffering) {
        ...
        File src = new File("./target/classes/io/codecourse/ReadingWritingExamples.class");
        File dest = new File("./target/classes/io/codecourse/ReadingWritingExamples2.class");
