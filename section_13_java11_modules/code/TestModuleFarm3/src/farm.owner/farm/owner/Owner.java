 ...
 * return "SK";
 * }
 * // In its API, Owner is exposing a type i.e. Animal from a different module
 * (farm.animals)
 * // => transitive i.e. requires transitive farm.animals; // in
 * module-info.java for farm.owner
 * public Animal getAnimal(String tag){
