package localization.codecourse;
...
public class LocalisingNumbers {
    ...
    public static void formatNumbers() {
        ...
        double n = 77_000.11;
        System.out.println(NumberFormat.getInstance(new Locale("en", "IE")).format(n)); // 77,000.11 (en_IE locale)
    ...
    public static void formatCurrencies() {
        // format: number --> String
        double n = 23.22;
        System.out.println(NumberFormat.getCurrencyInstance(new Locale("en", "IE")).format(n)); // €23.22 (en_IE locale)
